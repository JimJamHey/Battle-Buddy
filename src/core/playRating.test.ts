...
describe('parsePlayRating', () => {
  it('reads the Play-screen Rating label and ignores gold and other numbers', () => {
    ...
    expect(parsePlayRating('JimJamHey#1968')).toBeNull()
    expect(parsePlayRating('Shop JimJamHey#1968 Rating 5,216')).toBe(5216)
    ...
    expect(acceptObservedRating(1968, { previous: 5216, battleTag: 'JimJamHey#1968' })).toBe(false)
